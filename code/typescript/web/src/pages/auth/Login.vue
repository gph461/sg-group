...
.login
    ...
    background-color: color-mix(in srgb, var(--ant-primary-color), transparent 66%)
    margin:-24px
    padding: 24px
    min-height: 650px
...
.shadow
    box-shadow: 0 5px 30px color-mix(in srgb, var(--ant-primary-color), transparent 70%) !important
